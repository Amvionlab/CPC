...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append('dropdown', formData.dropdown); // Append dropdown value
    if (attachment) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 ml-10 pr-10 mb-0">
              <div className="flex items-center mb-2 mr-4">
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="ml-4 flex-grow text-xs bg-second border p-3 border-none rounded-md outline-none transition ease-in-out delay-150 focus:shadow-[0_0_6px_#5fdd33]"
                >
              ...
              <div className="flex justify-end mt-4">
                <button
                  type="submit"
                  className="bg-prime font-mont font-semibold text-md text-white py-2 px-8 rounded-md shadow-md focus:outline-none"
                >
                  Submit
                </button>
              </div>
