...
if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO $table_name (name, manufacturer, model, serial_number, location, user_name, asset_value, vendor_name, purchase_date, po_number, amc_from, amc_to, amc_interval, last_amc, procure_by, warranty_upto, post_date, is_active) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), 1)";
    $stmt = $conn->prepare($sql);
