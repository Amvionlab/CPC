import {
  NoSsr_default
} from "./chunk-XRBWQJJH.js";
import {
  Popper_default
} from "./chunk-S67K75GH.js";
import {
  useThemeProps
} from "./chunk-I2JQ2LQ7.js";
import {
  useTheme
} from "./chunk-YKLMJL35.js";
import {
  Typography_default
} from "./chunk-CZ4OSWRB.js";
import {
  shouldForwardProp
} from "./chunk-2CGVJHQ3.js";
import {
  appearance_default,
  ascending_default,
  band,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime11.jsxs)(React29.Fragment, {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime15.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime15.jsx)("thead", {
        children: (0, import_jsx_runtime15.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime15.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime15.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime15.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime15.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime15.jsx)(Typography_default, {
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React35.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React35.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React35.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(NoSsr_default, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(LegendPerItem, _extends({}, other, {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime23.jsxs)(React43.Fragment, {
    children: [(0, import_jsx_runtime23.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime23.jsx)("rect", _extends({
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(React46.Fragment, {});
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React47.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React48.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function useChartGradient() {
  ...
  return React50.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime29.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime29.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime29.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse,
          scale,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React51.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React51.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded11 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
...
var ChartContainer = React55.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime30.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime30.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime30.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime30.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React56.useRef(false);
  const rootRef = React56.useRef(null);
  const [width, setWidth] = React56.useState(0);
  const [height, setHeight] = React56.useState(0);
  const computeSize = React56.useCallback(() => {
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded12 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React57.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime31.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime31.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types20.default.arrayOf(import_prop_types20.default.object),
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
...
//# sourceMappingURL=chunk-LQCSAYIV.js.map
