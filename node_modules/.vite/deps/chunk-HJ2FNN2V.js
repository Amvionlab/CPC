...
var Portal = React20.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime15.jsx)(React20.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime15.jsx)(React20.Fragment, {
...
var ClassNameConfiguratorContext = React22.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass3) {
  ...
  } = React22.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React23.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React23.useEffect(() => {
  ...
  const updateRootElementName = React23.useCallback((instance) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HJ2FNN2V.js.map
