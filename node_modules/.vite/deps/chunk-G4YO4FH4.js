import {
  NoSsr_default
<<<<<<<< HEAD:node_modules/.vite/deps/chunk-TXEL44AN.js
} from "./chunk-CEUQ5FO2.js";
import {
  Popper_default,
  useThemeProps
} from "./chunk-ZMPGMCSA.js";
import {
  Typography_default
} from "./chunk-762ZKFNG.js";
import {
  useTheme
} from "./chunk-NXRJSRU7.js";
========
} from "./chunk-7QYADQNO.js";
import {
  Popper_default,
  useThemeProps
} from "./chunk-5R6NHHKP.js";
import {
  useTheme
...
>>>>>>>> 3c1acba34c2c12f5fd3b28a48bf2c8ff5c3033b4:node_modules/.vite/deps/chunk-G4YO4FH4.js
import {
  require_react_dom
} from "./chunk-RY6NLCXT.js";
import {
  shouldForwardProp
} from "./chunk-I3SBH4G7.js";
import {
  shouldForwardProp
} from "./chunk-WOFUKYJA.js";
import {
  init_esm,
  init_ownerWindow,
  init_useControlled,
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React34.Fragment, {
...
var ChartsSurface = React36.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime15.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime15.jsxs)(React37.Fragment, {
...
function useChartGradient() {
  ...
  return React39.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React40.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React40.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React41.useRef(null);
...
var ChartContainer = React42.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React43.useRef(false);
...
function ChartsText(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime20.jsx)("tspan", {
      x: x2,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React54.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React54.useMemo(() => {
...
var _excluded16 = ["drawingArea", "seriesToDisplay"];
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime31.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React60.Fragment, {
    children: [(0, import_jsx_runtime32.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime32.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime32.jsx)("rect", _extends({
...
var _excluded17 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter"];
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay
  }));
}
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React62.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime34.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime34.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime34.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime34.jsx)(ChartsAxisHighlightPath, {
...
var _excluded18 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && xTicks.map(({
      formattedValue,
      offset
    }) => (0, import_jsx_runtime36.jsx)(GridLine, {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset,
      x2: offset,
...
var BarChart = React69.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
  ...
  return (0, import_jsx_runtime41.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime41.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime41.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime41.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime41.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime41.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime41.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime41.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime41.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime41.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime41.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
...
<<<<<<<< HEAD:node_modules/.vite/deps/chunk-TXEL44AN.js
//# sourceMappingURL=chunk-TXEL44AN.js.map
========
//# sourceMappingURL=chunk-G4YO4FH4.js.map
>>>>>>>> 3c1acba34c2c12f5fd3b28a48bf2c8ff5c3033b4:node_modules/.vite/deps/chunk-G4YO4FH4.js
