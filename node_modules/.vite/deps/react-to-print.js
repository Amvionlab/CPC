    ...
    !function(e, t) {
      ...
      return function() {
        ...
        function p(e2, t2, o2, n2) {
          var r2, s2, l2;
          const { contentNode: c2, clonedContentNode: p2, clonedImgNodes: h2, clonedVideoNodes: f2, numResourcesToLoad: g, originalCanvasNodes: m } = o2, { bodyClass: b, fonts: y, ignoreGlobalStyles: v, pageStyle: w, nonce: E, suppressErrors: T, copyShadowRoots: A } = n2;
          e2.onload = null;
          const x = e2.contentDocument || (null === (r2 = e2.contentWindow) || void 0 === r2 ? void 0 : r2.document);
          if (x) {
            const o3 = x.body.appendChild(p2);
            A && d(c2, o3, !!T), y && ((null === (s2 = e2.contentDocument) || void 0 === s2 ? void 0 : s2.fonts) && (null === (l2 = e2.contentWindow) || void 0 === l2 ? void 0 : l2.FontFace) ? y.forEach((o4) => {
            ...
            }) : (y.forEach((e3) => t2(e3)), i({ messages: ['"react-to-print" is not able to load custom fonts because the browser does not support the FontFace API but will continue attempting to print the page'], suppressErrors: T })));
            ...
            for (let e3 = 0; e3 < m.length; ++e3) {
              ...
              if (void 0 === o4) {
                i({ messages: ["A canvas element could not be copied for printing, has it loaded? `onBeforePrint` likely resolved too early.", t3], suppressErrors: T });
                continue;
              }
...
`);
        ...
        function f(e2) {
          const { contentRef: t2, fonts: o2, ignoreGlobalStyles: n2, onBeforePrint: r2, onPrintError: c2, preserveAfterPrint: d2, suppressErrors: u2 } = e2, p2 = (0, s.useCallback)((s2) => {
            ...
            const f2 = p3.cloneNode(true), g = document.querySelectorAll("link[rel~='stylesheet'], link[as='style']"), m = f2.querySelectorAll("img"), b = f2.querySelectorAll("video"), y = o2 ? o2.length : 0, v = (n2 ? 0 : g.length) + m.length + b.length + y, w = [], E = [], T = function() {
