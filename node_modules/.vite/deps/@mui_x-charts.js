...
<<<<<<< HEAD
  useThemeProps
} from "./chunk-7PXIIBN7.js";
import {
  Typography_default
} from "./chunk-EWZOR5C2.js";
import {
  Portal_default
} from "./chunk-PUVIRP4J.js";
=======
  NoSsr_default,
  Popper_default
} from "./chunk-HZEOSZJ2.js";
import {
  Typography_default
} from "./chunk-KTR62NK5.js";
import {
  useThemeProps
} from "./chunk-5PST6O3A.js";
import "./chunk-IE6IMXIQ.js";
>>>>>>> ead8ac145df0303a6cd18d1c98dcab883d6e6204
import {
  require_react_dom
} from "./chunk-7I7T2IKX.js";
import {
  useTheme
} from "./chunk-SMBIZV4O.js";
import {
  useTheme
} from "./chunk-5TZ4QXKU.js";
import {
  shouldForwardProp
<<<<<<< HEAD
} from "./chunk-QAGEZ5SQ.js";
import "./chunk-2UH2JP76.js";
import "./chunk-D7ZASVPN.js";
=======
} from "./chunk-M5ITUSJX.js";
import "./chunk-2UH2JP76.js";
import "./chunk-D7ZASVPN.js";
import "./chunk-5556EKN3.js";
import "./chunk-LMCH44KZ.js";
>>>>>>> ead8ac145df0303a6cd18d1c98dcab883d6e6204
import {
  HTMLElementType,
  chainPropTypes,
...
<<<<<<< HEAD
} from "./chunk-BVYCDBCR.js";
import "./chunk-USXO7FMG.js";
import "./chunk-DYOW3SNX.js";
import {
  init_DefaultPropsProvider,
  useDefaultProps
} from "./chunk-2GCKWCRO.js";
=======
} from "./chunk-E2DPCTSG.js";
import "./chunk-IEPKYFU6.js";
>>>>>>> ead8ac145df0303a6cd18d1c98dcab883d6e6204
import {
  _extends,
...
} from "./chunk-RUGN6VR6.js";
=======
  styled_default
} from "./chunk-UMFGSL5G.js";
>>>>>>> ead8ac145df0303a6cd18d1c98dcab883d6e6204
import {
  clsx_default,
  init_clsx
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React10.useContext(SeriesContext);
  if (!isInitialized) {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React11.useMemo(() => {
  ...
  const providerValue = React11.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var useChartDimensions = (width, height, margin) => {
  ...
  const drawingArea = React14.useMemo(() => ({
...
var DrawingContext = React15.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React15.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React15.useCallback(({
    x: x2,
    y: y2
  }, targetElement) => {
  ...
  const value = React15.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React15.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
function CartesianContextProvider(props) {
  ...
  const xValues = React20.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React20.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime14.jsxs)(React32.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(React36.Fragment, {
...
function useMouseTracker() {
  ...
  const [mousePosition, setMousePosition] = React38.useState(null);
  React38.useEffect(() => {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime22.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime22.jsx)("thead", {
        children: (0, import_jsx_runtime22.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime22.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime22.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime22.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
            }), (0, import_jsx_runtime22.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime22.jsx)(Typography_default, {
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React44.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  ...
  return (0, import_jsx_runtime25.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime25.jsx)(ChartsLegendRoot, {
      ...
      children: itemsWithPosition.map(({
        ...
        children: [(0, import_jsx_runtime25.jsx)("rect", {
...
var _excluded10 = ["drawingArea", "seriesToDisplay"];
...
var _excluded11 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter"];
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React52.useRef({});
  const delauneyRef = React52.useRef(void 0);
  const lastFind = React52.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
true ? ChartsVoronoiHandler.propTypes = {
   ...
   */
  voronoiMaxRadius: import_prop_types21.default.number
} : void 0;
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React54.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React55.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React55.createContext(init));
...
var _excluded12 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick"];
...
var _excluded14 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes"];
...
function BarLabel(props) {
  ...
  const otherProps = _objectWithoutPropertiesLoose(themeProps, _excluded14);
...
var _excluded15 = ["seriesId", "classes", "color", "style", "dataIndex", "barLabel", "slots", "slotProps", "height", "width", "value"];
...
var _excluded16 = ["bars", "skipAnimation"];
var leaveStyle = ({
  layout,
  yOrigin,
  x: x2,
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(React61.Fragment, {
...
var _excluded17 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React62.Fragment, {
    children: [maskTransition((style, {
      ...
      return (0, import_jsx_runtime39.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime39.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2
      }, other, {
      ...
      return (0, import_jsx_runtime39.jsx)("g", {
        clipPath: `url(#${maskId})`,
        children: barElement
      });
    }), barLabel && (0, import_jsx_runtime39.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
var ChartsSurface = React64.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime40.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    ...
    children: [(0, import_jsx_runtime40.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime40.jsx)("desc", {
      children: desc
    }), children]
  }));
});
  ...
  return (0, import_jsx_runtime41.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime41.jsxs)(React65.Fragment, {
        children: [(0, import_jsx_runtime41.jsx)("stop", {
          offset: offset2,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime41.jsx)("stop", {
          offset: offset2,
...
function useChartGradient() {
  const {
    chartId
  } = React66.useContext(DrawingContext);
  return React66.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime42.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime42.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime42.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React67.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React67.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded19 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React68.useRef(null);
...
var ChartContainer = React69.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime43.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime43.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime43.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime43.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
          children: (0, import_jsx_runtime43.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime43.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime43.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime43.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime43.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React70.useRef(false);
  const rootRef = React70.useRef(null);
  const [width, setWidth] = React70.useState(0);
  const [height, setHeight] = React70.useState(0);
  const computeSize = React70.useCallback(() => {
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded20 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React71.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime44.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime44.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded26 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "axisHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className"];
...
var BarChart = React75.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
  ...
  return (0, import_jsx_runtime48.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime48.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime48.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime48.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime48.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime48.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime48.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime48.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime48.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime48.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime48.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.object, import_prop_types30.default.string]),
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.object, import_prop_types30.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types30.default.shape({
    classes: import_prop_types30.default.object,
    direction: import_prop_types30.default.oneOf(["column", "row"]),
   ...
   * @default null
   */
  rightAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.object, import_prop_types30.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types30.default.shape({
    axisContent: import_prop_types30.default.elementType,
    classes: import_prop_types30.default.object,
    itemContent: import_prop_types30.default.elementType,
    slotProps: import_prop_types30.default.object,
    slots: import_prop_types30.default.object,
    trigger: import_prop_types30.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.object, import_prop_types30.default.string]),
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React76.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
var _excluded27 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React77.Fragment, {
    children: [(0, import_jsx_runtime49.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime49.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top2 + height + bottom2
      })
    }), (0, import_jsx_runtime49.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime49.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded28 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(Area, _extends({}, other, areaProps));
}
...
var _excluded29 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime51.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime51.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React80.Fragment, {
    children: [(0, import_jsx_runtime52.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime52.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top2 + height + bottom2
      })
    }), (0, import_jsx_runtime52.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime52.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
true ? AnimatedLine.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  d: import_prop_types34.default.string.isRequired,
  ownerState: import_prop_types34.default.shape({
    classes: import_prop_types34.default.object,
    color: import_prop_types34.default.string.isRequired,
    gradientId: import_prop_types34.default.string,
    ...
    isFaded: import_prop_types34.default.bool.isRequired,
    isHighlighted: import_prop_types34.default.bool.isRequired
  }).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(Line, _extends({}, other, lineProps));
}
...
var _excluded32 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime54.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime54.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var _excluded33 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
true ? MarkElement.propTypes = {
   ...
   */
  dataIndex: import_prop_types37.default.number.isRequired,
   ...
   */
  shape: import_prop_types37.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
var _excluded34 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
var _excluded35 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime57.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
var _excluded36 = ["slots", "slotProps"];
function LineHighlightPlot(props) {
  ...
  const {
    axis
  } = React86.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime58.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime58.jsx)(Element2, _extends({
          id: seriesId,
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded37 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var LineChart = React87.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime59.jsxs)(ResponsiveChartContainer, _extends({
    ...
    }), (0, import_jsx_runtime59.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime59.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime59.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime59.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types41.default.oneOfType([import_prop_types41.default.object, import_prop_types41.default.string]),
   ...
   */
  disableLineItemHighlight: import_prop_types41.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  ...
  highlightedItem: import_prop_types41.default.shape({
    ...
    seriesId: import_prop_types41.default.oneOfType([import_prop_types41.default.number, import_prop_types41.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types41.default.oneOfType([import_prop_types41.default.object, import_prop_types41.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types41.default.shape({
    classes: import_prop_types41.default.object,
    direction: import_prop_types41.default.oneOf(["column", "row"]),
    hidden: import_prop_types41.default.bool,
    position: import_prop_types41.default.shape({
      horizontal: import_prop_types41.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types41.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types41.default.shape({
   ...
   */
  onAreaClick: import_prop_types41.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   */
  onLineClick: import_prop_types41.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types41.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types41.default.oneOfType([import_prop_types41.default.object, import_prop_types41.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types41.default.shape({
    axisContent: import_prop_types41.default.elementType,
    classes: import_prop_types41.default.object,
    itemContent: import_prop_types41.default.elementType,
    slotProps: import_prop_types41.default.object,
    slots: import_prop_types41.default.object,
    trigger: import_prop_types41.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types41.default.oneOfType([import_prop_types41.default.object, import_prop_types41.default.string]),
  viewBox: import_prop_types41.default.shape({
    height: import_prop_types41.default.number,
    width: import_prop_types41.default.number,
    x: import_prop_types41.default.number,
    y: import_prop_types41.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types41.default.arrayOf(import_prop_types41.default.shape({
    classes: import_prop_types41.default.object,
    ...
    labelFontSize: import_prop_types41.default.number,
    ...
    scaleType: import_prop_types41.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types41.default.object,
    slots: import_prop_types41.default.object,
    stroke: import_prop_types41.default.string,
    tickFontSize: import_prop_types41.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types41.default.arrayOf(import_prop_types41.default.shape({
    classes: import_prop_types41.default.object,
    colorMap: import_prop_types41.default.oneOfType([import_prop_types41.default.shape({
      colors: import_prop_types41.default.arrayOf(import_prop_types41.default.string).isRequired,
      type: import_prop_types41.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types41.default.oneOfType([import_prop_types41.default.instanceOf(Date), import_prop_types41.default.number]),
    min: import_prop_types41.default.oneOfType([import_prop_types41.default.instanceOf(Date), import_prop_types41.default.number]),
    position: import_prop_types41.default.oneOf(["left", "right"]),
    reverse: import_prop_types41.default.bool,
    scaleType: import_prop_types41.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types41.default.object,
    slots: import_prop_types41.default.object,
...
var _excluded38 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types42.default.shape({
    fade: import_prop_types42.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types42.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types42.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React89.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded39 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime61.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime61.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded40 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types44.default.string,
  ...
  isFaded: import_prop_types44.default.bool.isRequired,
  isHighlighted: import_prop_types44.default.bool.isRequired
} : void 0;

// node_modules/@mui/x-charts/esm/PieChart/PieArcLabelPlot.js
var import_jsx_runtime63 = __toESM(require_jsx_runtime());
var _excluded41 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime63.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime63.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types45.default.oneOfType([import_prop_types45.default.oneOf(["formattedValue", "label", "value"]), import_prop_types45.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types45.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types45.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types45.default.number,
  data: import_prop_types45.default.arrayOf(import_prop_types45.default.shape({
    color: import_prop_types45.default.string.isRequired,
    endAngle: import_prop_types45.default.number.isRequired,
    formattedValue: import_prop_types45.default.string.isRequired,
    ...
    label: import_prop_types45.default.oneOfType([import_prop_types45.default.func, import_prop_types45.default.string]),
    padAngle: import_prop_types45.default.number.isRequired,
    startAngle: import_prop_types45.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types45.default.shape({
    additionalRadius: import_prop_types45.default.number,
    arcLabelRadius: import_prop_types45.default.number,
    color: import_prop_types45.default.string,
    cornerRadius: import_prop_types45.default.number,
    innerRadius: import_prop_types45.default.number,
    outerRadius: import_prop_types45.default.number,
    paddingAngle: import_prop_types45.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types45.default.shape({
    additionalRadius: import_prop_types45.default.number,
    arcLabelRadius: import_prop_types45.default.number,
    color: import_prop_types45.default.string,
    cornerRadius: import_prop_types45.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types45.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React93.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
...
var _excluded42 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "sx", "tooltip", "axisHighlight", "skipAnimation", "legend", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className"];
var defaultMargin = {
  top: 5,
  bottom: 5,
  left: 5,
...
var PieChart = React94.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime65.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime65.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime65.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime65.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime65.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime65.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  const cleanData = React95.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime66.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime66.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types48.default.func,
  markerSize: import_prop_types48.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  series: import_prop_types48.default.object.isRequired,
  xScale: import_prop_types48.default.func.isRequired,
  yScale: import_prop_types48.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React96.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime67.jsx)(React96.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime67.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded43 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React97.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime68.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime68.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime68.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime68.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime68.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime68.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime68.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime68.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime68.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime68.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime68.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
  ...
  highlightedItem: import_prop_types50.default.shape({
    ...
    seriesId: import_prop_types50.default.oneOfType([import_prop_types50.default.number, import_prop_types50.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
  ...
  xAxis: import_prop_types50.default.arrayOf(import_prop_types50.default.shape({
    ...
    max: import_prop_types50.default.oneOfType([import_prop_types50.default.instanceOf(Date), import_prop_types50.default.number]),
    min: import_prop_types50.default.oneOfType([import_prop_types50.default.instanceOf(Date), import_prop_types50.default.number]),
    position: import_prop_types50.default.oneOf(["bottom", "top"]),
  ...
  yAxis: import_prop_types50.default.arrayOf(import_prop_types50.default.shape({
    ...
    max: import_prop_types50.default.oneOfType([import_prop_types50.default.instanceOf(Date), import_prop_types50.default.number]),
    min: import_prop_types50.default.oneOfType([import_prop_types50.default.instanceOf(Date), import_prop_types50.default.number]),
    position: import_prop_types50.default.oneOf(["left", "right"]),
    reverse: import_prop_types50.default.bool,
    scaleType: import_prop_types50.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types50.default.object,
    slots: import_prop_types50.default.object,
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types50.default.arrayOf(import_prop_types50.default.shape({
    colorMap: import_prop_types50.default.oneOfType([import_prop_types50.default.shape({
      colors: import_prop_types50.default.arrayOf(import_prop_types50.default.string).isRequired,
      type: import_prop_types50.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types50.default.string,
...
var _excluded44 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React98.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime69.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    }), plotType === "line" && (0, import_jsx_runtime69.jsxs)(React98.Fragment, {
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types51.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types51.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types51.default.arrayOf(import_prop_types51.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types51.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types51.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types51.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types51.default.shape({
    classes: import_prop_types51.default.object,
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types51.default.shape({
    classes: import_prop_types51.default.object,
    colorMap: import_prop_types51.default.oneOfType([import_prop_types51.default.shape({
      colors: import_prop_types51.default.arrayOf(import_prop_types51.default.string).isRequired,
      type: import_prop_types51.default.oneOf(["ordinal"]).isRequired,
...
var GaugeContext = React99.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime70.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React99.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime71 = __toESM(require_jsx_runtime());
var _excluded45 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React100.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const svgRef = React100.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime71.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime71.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime71.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime71.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime72.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime73.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded46 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime74.jsx)("g", {
    className,
    children: (0, import_jsx_runtime74.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
var _excluded47 = ["text", "children", "classes", "className"];
...
var Gauge = React104.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime75.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime75.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime75.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime75.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
   ...
   * @default false
   */
  disableAxisListener: import_prop_types54.default.bool,
  /**
   * The end angle (deg).
   * @default 360
   */
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types54.default.shape({
  ...
  viewBox: import_prop_types54.default.shape({
    height: import_prop_types54.default.number,
    width: import_prop_types54.default.number,
    x: import_prop_types54.default.number,
    y: import_prop_types54.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
