...
>>>>>>> 1ed4ae4c4dee8d626623f2dde4ce6825ea69ad6e
import {
  Popper_default,
  useThemeProps
<<<<<<< HEAD
} from "./chunk-ZBDFFCFC.js";
import "./chunk-IMBST4Q5.js";
import {
  useTheme
} from "./chunk-LYMG6VSI.js";
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
} from "./chunk-ORXLEAFP.js";
import "./chunk-MURX47ZY.js";
=======
<<<<<<< HEAD
...
var InteractionContext = React35.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React35.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React35.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function useMouseTracker() {
  ...
  const [mousePosition, setMousePosition] = React36.useState(null);
  React36.useEffect(() => {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types12.default.object.isRequired,
  /**
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React40.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React40.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const isRTL = theme.direction === "rtl";
  const drawingArea = useDrawingArea();
  const labelStyle = React42.useMemo(
  ...
  const padding = React42.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React42.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React42.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React42.useMemo(() => {
...
var _excluded8 = ["drawingArea", "seriesToDisplay"];
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types16.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types16.default.oneOfType([import_prop_types16.default.number, import_prop_types16.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types16.default.oneOfType([import_prop_types16.default.func, import_prop_types16.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types16.default.oneOfType([import_prop_types16.default.func, import_prop_types16.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types16.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types16.default.number,
  /**
...
var _excluded9 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter"];
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types17.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types17.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React50.useRef({});
  const delauneyRef = React50.useRef(void 0);
  const lastFind = React50.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React52.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React53.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React53.createContext(init));
...
var _excluded10 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick"];
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(Bar, _extends({}, barProps));
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime33.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime33.jsx)(BarClipRect, {
      ownerState: rest,
      style
    })
  });
...
var _excluded12 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes"];
...
function BarLabel(props) {
  ...
  const otherProps = _objectWithoutPropertiesLoose(themeProps, _excluded12);
  return (0, import_jsx_runtime34.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
var _excluded13 = ["seriesId", "classes", "color", "style", "dataIndex", "barLabel", "slots", "slotProps", "height", "width", "value"];
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
true ? BarLabelItem.propTypes = {
  ...
  seriesId: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
...
var _excluded14 = ["bars", "skipAnimation"];
var leaveStyle = ({
  layout,
  yOrigin,
  x: x2,
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(React59.Fragment, {
    children: barLabelTransition((style, {
      ...
      width,
      height
    }) => (0, import_jsx_runtime36.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color2,
...
var _excluded15 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime37.jsxs)(React60.Fragment, {
    children: [maskTransition((style, {
      ...
      return (0, import_jsx_runtime37.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime37.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2
      }, other, {
      ...
      return (0, import_jsx_runtime37.jsx)("g", {
        clipPath: `url(#${maskId})`,
        children: barElement
      });
    }), barLabel && (0, import_jsx_runtime37.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React61.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var _excluded16 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React62.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime38.jsxs)(ChartChartsSurfaceStyles, _extends({
    ...
    children: [(0, import_jsx_runtime38.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime38.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime39.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset = isReversed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime39.jsxs)(React63.Fragment, {
        children: [(0, import_jsx_runtime39.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime39.jsx)("stop", {
          offset,
...
function useChartGradient() {
  ...
  return React64.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime40.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime40.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime40.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React65.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React65.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded17 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
...
var ChartContainer = React67.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime41.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime41.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime41.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime41.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
          children: (0, import_jsx_runtime41.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime41.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime41.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime41.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime41.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React68.useRef(false);
  const rootRef = React68.useRef(null);
  const [width, setWidth] = React68.useState(0);
  const [height, setHeight] = React68.useState(0);
  const computeSize = React68.useCallback(() => {
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded18 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React69.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime42.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime42.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types27.default.arrayOf(import_prop_types27.default.object),
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types27.default.arrayOf(import_prop_types27.default.shape({
    colorMap: import_prop_types27.default.oneOfType([import_prop_types27.default.shape({
      colors: import_prop_types27.default.arrayOf(import_prop_types27.default.string).isRequired,
      type: import_prop_types27.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types27.default.string,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime45.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime45.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded21 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "axisHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className"];
...
var BarChart = React73.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
  ...
  return (0, import_jsx_runtime46.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime46.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime46.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime46.jsxs)("g", _extends({}, clipPathGroupProps, {
    ...
    })), (0, import_jsx_runtime46.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime46.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime46.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime46.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @returns {string} The formatted label.
   */
  barLabel: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["value"]), import_prop_types28.default.func]),
  /**
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types28.default.number,
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.object, import_prop_types28.default.string]),
   ...
   */
  grid: import_prop_types28.default.shape({
    horizontal: import_prop_types28.default.bool,
   ...
   * @default 'vertical'
   */
  layout: import_prop_types28.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.object, import_prop_types28.default.string]),
  /**
   ...
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types28.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   * @default null
   */
  rightAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.object, import_prop_types28.default.string]),
  /**
   ...
   * @default null
   */
  topAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.object, import_prop_types28.default.string]),
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React74.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime47.jsxs)(React75.Fragment, {
    children: [(0, import_jsx_runtime47.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime47.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(Area, _extends({}, other, areaProps));
}
...
var _excluded26 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime49.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime49.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime50.jsxs)(React78.Fragment, {
    children: [(0, import_jsx_runtime50.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime50.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime50.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(Line, _extends({}, other, lineProps));
}
...
var _excluded29 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime52.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime52.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var _excluded30 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
var _excluded31 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
  ...
  return (0, import_jsx_runtime54.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime54.jsx)("g", {
          clipPath: `url(#${clipId})`,
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime54.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded32 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime55.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
var _excluded33 = ["slots", "slotProps"];
function LineHighlightPlot(props) {
  ...
  const {
    axis
  } = React84.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime56.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime56.jsx)(Element, _extends({
          id: seriesId,
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded34 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var LineChart = React85.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime57.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime57.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime57.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime57.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime57.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime57.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime57.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime57.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime57.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime57.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime57.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime57.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime57.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime57.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime57.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
...
var _excluded35 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps();
  return (0, import_jsx_runtime58.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React87.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded36 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime59.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime59.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded37 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime60.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
var _excluded38 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime61.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime61.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React91.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime62.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime62.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime62.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime62.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime62.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var _excluded39 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "sx", "tooltip", "axisHighlight", "skipAnimation", "legend", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className"];
var defaultMargin = {
  top: 5,
  bottom: 5,
  left: 5,
...
var PieChart = React92.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime63.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    ...
    children: [(0, import_jsx_runtime63.jsx)(ChartsAxis, {
      ...
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime63.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime63.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime63.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  const cleanData = React93.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime64.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime64.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(React94.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime65.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded40 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React95.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime66.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime66.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime66.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime66.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime66.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime66.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime66.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime66.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime66.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime66.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime66.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
...
var _excluded41 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React96.forwardRef(function SparkLineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime67.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime67.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime67.jsxs)(React96.Fragment, {
      children: [(0, import_jsx_runtime67.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime67.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime67.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime67.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime67.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime68.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
...
var _excluded42 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React98.forwardRef(function GaugeContainer2(props, ref) {
  ...
  const svgRef = React98.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime69.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime69.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime69.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime69.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime70.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded43 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime72.jsx)("g", {
    className,
    children: (0, import_jsx_runtime72.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
var _excluded44 = ["text", "children", "classes", "className"];
...
var Gauge = React102.forwardRef(function Gauge2(props, ref) {
  ...
  return (0, import_jsx_runtime73.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime73.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime73.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime73.jsx)(GaugeValueText, {
