...
=======
} from "./chunk-ZLNIA4DO.js";
>>>>>>> bf831c89e777f074865d7e7a9324b377a99ca4f3
import {
  Typography_default
} from "./chunk-YR3625U7.js";
import "./chunk-SKI3ODDI.js";
import {
  useTheme
} from "./chunk-RE34CMAX.js";
import {
  require_react_dom
...
=======
} from "./chunk-AU74J3MT.js";
import "./chunk-2UH2JP76.js";
import "./chunk-D7ZASVPN.js";
import "./chunk-537MAHNJ.js";
>>>>>>> bf831c89e777f074865d7e7a9324b377a99ca4f3
import {
  init_esm,
  init_ownerWindow,
...
>>>>>>> 002d4e288c77f3a16adbc43269c31e957cdd3b4f
=======
} from "./chunk-IWBTPHL2.js";
import "./chunk-IEPKYFU6.js";
import "./chunk-YW2Y5MZZ.js";
>>>>>>> bf831c89e777f074865d7e7a9324b377a99ca4f3
import {
  _extends,
...
=======
  styled_default
} from "./chunk-B3OGL3YU.js";
import {
  clsx_default,
  init_clsx
} from "./chunk-EOTPXI7U.js";
>>>>>>> bf831c89e777f074865d7e7a9324b377a99ca4f3
import {
  require_prop_types
...
var InteractionContext = React34.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React34.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React34.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React37.useContext(ZAxisContext);
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime19.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime19.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime19.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime19.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React39.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React39.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React39.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const isRTL = theme.direction === "rtl";
  const drawingArea = useDrawingArea();
  const labelStyle = React41.useMemo(
  ...
  const padding = React41.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React41.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React41.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React41.useMemo(() => {
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
...
function ChartsVoronoiHandler(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React49.Fragment, {});
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React51.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React52.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React52.createContext(init));
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(Bar, _extends({}, barProps));
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime32.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime32.jsx)(BarClipRect, {
      ownerState: rest,
      style
    })
  });
...
function BarLabel(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(React58.Fragment, {
    children: barLabelTransition((style, {
      ...
      width,
      height
    }) => (0, import_jsx_runtime35.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color2,
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React59.Fragment, {
    children: [maskTransition((style, {
      ...
      return (0, import_jsx_runtime36.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime36.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2
      }, other, {
    ...
    }), barLabel && (0, import_jsx_runtime36.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React60.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React61.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime37.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime38.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset = isReversed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime38.jsxs)(React62.Fragment, {
        children: [(0, import_jsx_runtime38.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime38.jsx)("stop", {
          offset,
...
function useChartGradient() {
  const {
    chartId
  } = React63.useContext(DrawingContext);
  return React63.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
  ...
  return (0, import_jsx_runtime39.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime39.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React64.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React64.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React65.useRef(null);
...
var ChartContainer = React66.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime40.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime40.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime40.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime40.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
          children: (0, import_jsx_runtime40.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime40.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime40.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime40.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime40.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React67.useRef(false);
  const rootRef = React67.useRef(null);
  const [width, setWidth] = React67.useState(0);
  const [height, setHeight] = React67.useState(0);
  const computeSize = React67.useCallback(() => {
...
var ResponsiveChartContainer = React68.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime41.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime41.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
var BarChart = React72.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React73.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React74.Fragment, {
    children: [(0, import_jsx_runtime46.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime46.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime46.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime46.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(Area, _extends({}, other, areaProps));
}
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime48.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime48.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React77.Fragment, {
    children: [(0, import_jsx_runtime49.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime49.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime51.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime51.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(MarkElementPath, _extends({}, other, {
    style: {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime53.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime53.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime55.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime55.jsx)(Element, _extends({
          id: seriesId,
...
var LineChart = React84.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime56.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime56.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime56.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime56.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime56.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime56.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime56.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime56.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime56.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime56.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime56.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime56.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime56.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime56.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime56.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
  ...
  highlightedItem: import_prop_types38.default.shape({
    ...
    seriesId: import_prop_types38.default.oneOfType([import_prop_types38.default.number, import_prop_types38.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
  ...
  yAxis: import_prop_types38.default.arrayOf(import_prop_types38.default.shape({
    ...
    max: import_prop_types38.default.oneOfType([import_prop_types38.default.instanceOf(Date), import_prop_types38.default.number]),
    min: import_prop_types38.default.oneOfType([import_prop_types38.default.instanceOf(Date), import_prop_types38.default.number]),
    position: import_prop_types38.default.oneOf(["left", "right"]),
    reverse: import_prop_types38.default.bool,
    scaleType: import_prop_types38.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types38.default.object,
    slots: import_prop_types38.default.object,
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types39.default.shape({
    fade: import_prop_types39.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types39.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types39.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React86.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React90.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime61.jsxs)("g", {
...
var PieChart = React91.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime62.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime62.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime62.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime62.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime62.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime62.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime62.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  const cleanData = React92.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime63.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime63.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React93.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime64.jsx)(React93.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime64.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
var ScatterChart = React94.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime65.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime65.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime65.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime65.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime65.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime65.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime65.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime65.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime65.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime65.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime65.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
...
var SparkLineChart = React95.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime66.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime66.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime66.jsxs)(React95.Fragment, {
      children: [(0, import_jsx_runtime66.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime66.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime66.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime66.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime66.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
true ? SparkLineChart.propTypes = {
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types48.default.shape({
    classes: import_prop_types48.default.object,
    colorMap: import_prop_types48.default.oneOfType([import_prop_types48.default.shape({
      colors: import_prop_types48.default.arrayOf(import_prop_types48.default.string).isRequired,
      type: import_prop_types48.default.oneOf(["ordinal"]).isRequired,
...
var GaugeContext = React96.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime67.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React96.useContext(GaugeContext);
}
...
var GaugeContainer = React97.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const svgRef = React97.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime68.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime68.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime68.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime68.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime69.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime70.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime71.jsx)("g", {
    className,
    children: (0, import_jsx_runtime71.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
var Gauge = React101.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime72.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime72.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime72.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime72.jsx)(GaugeValueText, {
