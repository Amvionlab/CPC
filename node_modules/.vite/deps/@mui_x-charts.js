...
<<<<<<< HEAD
  Portal_default
} from "./chunk-OV63IGMB.js";
import {
  Typography_default
} from "./chunk-ZNDXWJDA.js";
import {
  require_react_dom
...
import {
  ...
  useTheme
} from "./chunk-J777CQNX.js";
=======
  Typography_default
} from "./chunk-LMR35JA4.js";
import {
  Portal_default
} from "./chunk-ER5LTMWV.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-LOKVBMOX.js";
import {
  require_react_dom
} from "./chunk-CQ2FN4UO.js";
>>>>>>> bee8042f2cedc067737bb2d946f94cba12e13892
import {
  ...
  useThemeProps
<<<<<<< HEAD
} from "./chunk-PKX26W7T.js";
=======
} from "./chunk-AEF6ZBCV.js";
>>>>>>> bee8042f2cedc067737bb2d946f94cba12e13892
...
<<<<<<< HEAD
} from "./chunk-GMEDN6LY.js";
import "./chunk-G5I52J6L.js";
=======
} from "./chunk-DAFE7BPW.js";
import "./chunk-5ALBUZNE.js";
>>>>>>> bee8042f2cedc067737bb2d946f94cba12e13892
import {
  _extends,
  ...
  useDefaultProps
<<<<<<< HEAD
} from "./chunk-MRLZFTEK.js";
=======
} from "./chunk-HQNJBFFA.js";
>>>>>>> bee8042f2cedc067737bb2d946f94cba12e13892
import {
  clsx_default,
  init_clsx
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    var React107 = _interopRequireWildcard(require_react());
    ...
    function _interopRequireWildcard(e, r) {
      ...
      for (var u4 in e) if ("default" !== u4 && Object.prototype.hasOwnProperty.call(e, u4)) {
        var i = a2 ? Object.getOwnPropertyDescriptor(e, u4) : null;
        i && (i.get || i.set) ? Object.defineProperty(n, u4, i) : n[u4] = e[u4];
      }
    ...
    function useTheme3(defaultTheme2 = null) {
      const contextTheme = React107.useContext(_styledEngine.ThemeContext);
...
function toRgb(color2) {
  ...
  return (0, import_colorManipulator.hslToRgb)(color2);
}
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    Object.keys(palette).forEach((color2) => {
      ...
      if (colors3 && typeof colors3 === "object") {
        if (colors3.main) {
          setColor(palette[color2], "mainChannel", (0, import_colorManipulator.private_safeColorChannel)(toRgb(colors3.main)));
        }
        if (colors3.light) {
          setColor(palette[color2], "lightChannel", (0, import_colorManipulator.private_safeColorChannel)(toRgb(colors3.light)));
        }
        if (colors3.dark) {
          setColor(palette[color2], "darkChannel", (0, import_colorManipulator.private_safeColorChannel)(toRgb(colors3.dark)));
        }
        if (colors3.contrastText) {
          setColor(palette[color2], "contrastTextChannel", (0, import_colorManipulator.private_safeColorChannel)(toRgb(colors3.contrastText)));
        }
        if (color2 === "text") {
...
var _excluded3 = ["highlighted", "faded"];
...
function blurf(radius) {
  ...
  return (T, S, start3, stop2, step) => {
    ...
    for (let i = start3, j = stop2; i <= j; i += step) {
      ...
      T[i] = (sum4 + t * (S[Math.max(start3, i - s1)] + S[Math.min(stop2, i + s1)])) / w;
...
function DrawingProvider(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(SvgContext.Provider, {
    value: refValue,
    children: (0, import_jsx_runtime7.jsx)(DrawingContext.Provider, {
      value,
      children
    })
  });
...
function CartesianContextProvider(props) {
  ...
  const xValues = React22.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React22.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
  ...
  return (0, import_jsx_runtime8.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
...
function ChartsXReferenceLine(props) {
  ...
  if (xPosition === void 0) {
    if (true) {
      warnOnce2(`MUI X: the value ${x2} does not exist in the data of x axis with id ${axisId}.`, "error");
    }
    return null;
  }
  ...
  return (0, import_jsx_runtime11.jsxs)(ReferenceLineRoot, {
    className: classes.root,
    children: [(0, import_jsx_runtime11.jsx)("path", {
      d,
      className: classes.line,
      style: lineStyle
    }), (0, import_jsx_runtime11.jsx)(ChartsText, _extends({}, textParams, {
...
function ChartsYReferenceLine(props) {
  ...
  if (yPosition === void 0) {
    if (true) {
      warnOnce2(`MUI X: the value ${y2} does not exist in the data of y axis with id ${axisId}.`, "error");
    }
    return null;
  }
  ...
  return (0, import_jsx_runtime12.jsxs)(ReferenceLineRoot, {
    className: classes.root,
    children: [(0, import_jsx_runtime12.jsx)("path", {
      d,
      className: classes.line,
      style: lineStyle
    }), (0, import_jsx_runtime12.jsx)(ChartsText, _extends({}, textParams, {
      style: _extends({}, textParams.style, labelStyle)
    }))]
  });
}
...
function ChartsReferenceLine(props) {
  ...
  if (x2 !== void 0) {
    return (0, import_jsx_runtime13.jsx)(ChartsXReferenceLine, _extends({}, props));
  }
  return (0, import_jsx_runtime13.jsx)(ChartsYReferenceLine, _extends({}, props));
}
true ? ChartsReferenceLine.propTypes = {
   ...
   * @default 'middle'
   */
  labelAlign: import_prop_types6.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   */
  lineStyle: import_prop_types6.default.object,
  /**
   * Additional space around the label in px.
   * Can be a number or an object `{ x, y }` to distinguish space with the reference line and space with axes.
   * @default 5
   */
  spacing: import_prop_types6.default.oneOfType([import_prop_types6.default.number, import_prop_types6.default.shape({
   ...
   */
  x: import_prop_types6.default.oneOfType([import_prop_types6.default.instanceOf(Date), import_prop_types6.default.number, import_prop_types6.default.string]),
  /**
   * The y value associated with the reference line.
   * If defined the reference line will be horizontal.
   */
  y: import_prop_types6.default.oneOfType([import_prop_types6.default.instanceOf(Date), import_prop_types6.default.number, import_prop_types6.default.string])
} : void 0;
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime15.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime15.jsx)(Line, _extends({
      ...
      const showLabel = offset2 >= top2 - 1 && offset2 <= height + top2 + 1;
      if (!showLabel) {
        return null;
      }
...
var Popper3 = React37.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(NoSsr_default, {
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React46.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  ...
  return (0, import_jsx_runtime27.jsx)(NoSsr_default, {
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime30.jsx)("linearGradient", {
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime30.jsx)("stop", {
        offset: offset2,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React51.Fragment, {
    children: [(0, import_jsx_runtime31.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime31.jsx)("rect", _extends({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime33.jsxs)(React53.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime33.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime33.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime33.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime33.jsx)(ChartsAxisHighlightPath, {
...
var Voronoi = class {
  ...
  *neighbors(i) {
  ...
  _clipSegment(x0, y0, x1, y1, c0, c12) {
    const flip2 = c0 < c12;
    if (flip2) [x0, y0, x1, y1, c0, c12] = [x1, y1, x0, y0, c12, c0];
    while (true) {
      if (c0 === 0 && c12 === 0) return flip2 ? [x1, y1, x0, y0] : [x0, y0, x1, y1];
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React54.useRef({});
  const delauneyRef = React54.useRef(void 0);
  const lastFind = React54.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
var clamp = (min4, max4, v2) => Math.min(Math.max(v2, min4), max4);
var colors2 = {
  transparent: 0,
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React56.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React57.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React57.createContext(init));
...
var _excluded14 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick"];
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(animated.rect, {
...
var _excluded16 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes"];
...
function BarLabel(props) {
  ...
  const otherProps = _objectWithoutPropertiesLoose(themeProps, _excluded16);
  return (0, import_jsx_runtime38.jsx)(BarLabelComponent, _extends({}, otherProps));
}
true ? BarLabel.propTypes = {
  ...
  isFaded: import_prop_types25.default.bool.isRequired,
  isHighlighted: import_prop_types25.default.bool.isRequired,
...
var _excluded17 = ["seriesId", "classes", "color", "style", "dataIndex", "barLabel", "slots", "slotProps", "height", "width", "value"];
...
function BarLabelItem(props) {
  ...
  } = _useSlotProps, barLabelProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded25);
  if (!barLabel) {
    return null;
  }
...
true ? BarLabelItem.propTypes = {
  ...
  dataIndex: import_prop_types26.default.number.isRequired,
  /**
...
var _excluded18 = ["bars", "skipAnimation"];
var leaveStyle = ({
  layout,
  yOrigin,
  x: x2,
...
var _excluded19 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel"];
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React65.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var _excluded20 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React66.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime42.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    ...
    children: [(0, import_jsx_runtime42.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime42.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime43.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset2 = isReversed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime43.jsxs)(React67.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React68.useContext(DrawingContext);
  return React68.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime44.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime44.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime44.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React69.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React69.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded21 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React70.useRef(null);
...
var ChartContainer = React71.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime45.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime45.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime45.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime45.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
          children: (0, import_jsx_runtime45.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime45.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime45.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime45.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime45.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded26 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React73.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime46.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime46.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(StyledText, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(StyledText2, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime49.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime49.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded29 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "axisHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className"];
var useBarChartProps = (props) => {
  const {
    ...
    barLabel,
    className
  } = props, rest = _objectWithoutPropertiesLoose(props, _excluded29);
  const id = useId();
...
var BarChart = React77.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
  ...
  return (0, import_jsx_runtime50.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime50.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime50.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime50.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime50.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime50.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime50.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime50.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime50.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime50.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime50.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @default 'vertical'
   */
  layout: import_prop_types31.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React78.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
var _excluded30 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React79.Fragment, {
    children: [(0, import_jsx_runtime51.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime51.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top2 + height + bottom2
      })
    }), (0, import_jsx_runtime51.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime51.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
true ? AnimatedArea.propTypes = {
  ...
  ownerState: import_prop_types32.default.shape({
    ...
    isFaded: import_prop_types32.default.bool.isRequired,
    isHighlighted: import_prop_types32.default.bool.isRequired
  }).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
...
var _excluded31 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
true ? AreaElement.propTypes = {
  ...
  d: import_prop_types33.default.string.isRequired,
  gradientId: import_prop_types33.default.string,
...
var _excluded32 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
var _excluded33 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime54.jsxs)(React82.Fragment, {
    children: [(0, import_jsx_runtime54.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime54.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top2 + height + bottom2
      })
    }), (0, import_jsx_runtime54.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime54.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
true ? AnimatedLine.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  d: import_prop_types35.default.string.isRequired,
  ownerState: import_prop_types35.default.shape({
    classes: import_prop_types35.default.object,
    color: import_prop_types35.default.string.isRequired,
    gradientId: import_prop_types35.default.string,
...
var _excluded34 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
true ? LineElement.propTypes = {
  ...
  d: import_prop_types36.default.string.isRequired,
...
var _excluded35 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
var _excluded36 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime57.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types38.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
var _excluded37 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime58.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime58.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded38 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime60.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime60.jsx)(Element2, _extends({
          id: seriesId,
...
init_objectWithoutPropertiesLoose();
init_useId();
var _excluded40 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var LineChart = React89.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime61.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime61.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime61.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime61.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime61.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime61.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime61.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime61.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime61.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime61.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime61.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime61.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime61.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime61.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime61.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types42.default.shape({
    x: import_prop_types42.default.oneOf(["band", "line", "none"]),
    y: import_prop_types42.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.object, import_prop_types42.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types42.default.oneOfType([import_prop_types42.default.arrayOf(import_prop_types42.default.string), import_prop_types42.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types42.default.arrayOf(import_prop_types42.default.object),
   ...
   * @default false
   */
  disableAxisListener: import_prop_types42.default.bool,
  /**
   * If `true`, render the line highlight item.
   */
  disableLineItemHighlight: import_prop_types42.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types42.default.shape({
    horizontal: import_prop_types42.default.bool,
    vertical: import_prop_types42.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types42.default.number,
  /**
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types42.default.shape({
    dataIndex: import_prop_types42.default.number,
    seriesId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.object, import_prop_types42.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types42.default.shape({
    classes: import_prop_types42.default.object,
    direction: import_prop_types42.default.oneOf(["column", "row"]),
    hidden: import_prop_types42.default.bool,
    position: import_prop_types42.default.shape({
      horizontal: import_prop_types42.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types42.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types42.default.shape({
   ...
   */
  onAreaClick: import_prop_types42.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types42.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   */
  onHighlightChange: import_prop_types42.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types42.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types42.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.object, import_prop_types42.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types42.default.shape({
    axisContent: import_prop_types42.default.elementType,
    classes: import_prop_types42.default.object,
    itemContent: import_prop_types42.default.elementType,
    slotProps: import_prop_types42.default.object,
    slots: import_prop_types42.default.object,
    trigger: import_prop_types42.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.object, import_prop_types42.default.string]),
  viewBox: import_prop_types42.default.shape({
    height: import_prop_types42.default.number,
    width: import_prop_types42.default.number,
    x: import_prop_types42.default.number,
    y: import_prop_types42.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    classes: import_prop_types42.default.object,
    colorMap: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
      colors: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      type: import_prop_types42.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types42.default.string,
      values: import_prop_types42.default.arrayOf(import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number, import_prop_types42.default.string]).isRequired)
    }), import_prop_types42.default.shape({
      color: import_prop_types42.default.oneOfType([import_prop_types42.default.arrayOf(import_prop_types42.default.string.isRequired), import_prop_types42.default.func]).isRequired,
      max: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
      min: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
      type: import_prop_types42.default.oneOf(["continuous"]).isRequired
    }), import_prop_types42.default.shape({
      colors: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      thresholds: import_prop_types42.default.arrayOf(import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]).isRequired).isRequired,
      type: import_prop_types42.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types42.default.array,
    dataKey: import_prop_types42.default.string,
    disableLine: import_prop_types42.default.bool,
    disableTicks: import_prop_types42.default.bool,
    fill: import_prop_types42.default.string,
    hideTooltip: import_prop_types42.default.bool,
    ...
    labelFontSize: import_prop_types42.default.number,
    labelStyle: import_prop_types42.default.object,
    max: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
    min: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
    position: import_prop_types42.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types42.default.bool,
    scaleType: import_prop_types42.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types42.default.object,
    slots: import_prop_types42.default.object,
    stroke: import_prop_types42.default.string,
    tickFontSize: import_prop_types42.default.number,
    tickInterval: import_prop_types42.default.oneOfType([import_prop_types42.default.oneOf(["auto"]), import_prop_types42.default.array, import_prop_types42.default.func]),
    tickLabelInterval: import_prop_types42.default.oneOfType([import_prop_types42.default.oneOf(["auto"]), import_prop_types42.default.func]),
    tickLabelPlacement: import_prop_types42.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types42.default.object,
    tickMaxStep: import_prop_types42.default.number,
    tickMinStep: import_prop_types42.default.number,
    tickNumber: import_prop_types42.default.number,
    tickPlacement: import_prop_types42.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types42.default.number,
    valueFormatter: import_prop_types42.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    classes: import_prop_types42.default.object,
    colorMap: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
      colors: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      type: import_prop_types42.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
    min: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
    position: import_prop_types42.default.oneOf(["left", "right"]),
    reverse: import_prop_types42.default.bool,
    scaleType: import_prop_types42.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types42.default.object,
    slots: import_prop_types42.default.object,
...
var _excluded41 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps();
  return (0, import_jsx_runtime62.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  dataIndex: import_prop_types43.default.number.isRequired,
  /**
   * @deprecated Use the `isFaded` or `isHighlighted` props instead.
   */
  highlightScope: import_prop_types43.default.shape({
    fade: import_prop_types43.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types43.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types43.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React91.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded42 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime63.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime63.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcPlot.propTypes = {
  ...
  data: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    ...
    label: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.string]),
...
var _excluded43 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime64.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types45.default.string,
...
var _excluded44 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime65.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime65.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types46.default.oneOfType([import_prop_types46.default.oneOf(["formattedValue", "label", "value"]), import_prop_types46.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types46.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types46.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types46.default.number,
  data: import_prop_types46.default.arrayOf(import_prop_types46.default.shape({
    ...
    endAngle: import_prop_types46.default.number.isRequired,
    formattedValue: import_prop_types46.default.string.isRequired,
    ...
    label: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.string]),
    padAngle: import_prop_types46.default.number.isRequired,
    startAngle: import_prop_types46.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types46.default.shape({
    additionalRadius: import_prop_types46.default.number,
    arcLabelRadius: import_prop_types46.default.number,
    color: import_prop_types46.default.string,
    cornerRadius: import_prop_types46.default.number,
    innerRadius: import_prop_types46.default.number,
    outerRadius: import_prop_types46.default.number,
    paddingAngle: import_prop_types46.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types46.default.shape({
    additionalRadius: import_prop_types46.default.number,
    arcLabelRadius: import_prop_types46.default.number,
    color: import_prop_types46.default.string,
    cornerRadius: import_prop_types46.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types46.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React95.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime66.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime66.jsx)("g", {
        ...
        children: (0, import_jsx_runtime66.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime66.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime66.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var _excluded45 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "sx", "tooltip", "axisHighlight", "skipAnimation", "legend", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className"];
var defaultMargin = {
  top: 5,
  bottom: 5,
  left: 5,
...
var PieChart = React96.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime67.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime67.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime67.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime67.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime67.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime67.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  const cleanData = React97.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime68.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime68.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types49.default.func,
  markerSize: import_prop_types49.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  xScale: import_prop_types49.default.func.isRequired,
  yScale: import_prop_types49.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React98.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime69.jsx)(React98.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime69.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded46 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React99.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime70.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime70.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime70.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime70.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime70.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime70.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime70.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime70.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime70.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime70.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime70.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default { x: 'none', y: 'none' }
   */
  axisHighlight: import_prop_types51.default.shape({
    x: import_prop_types51.default.oneOf(["band", "line", "none"]),
    y: import_prop_types51.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types51.default.oneOfType([import_prop_types51.default.object, import_prop_types51.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types51.default.oneOfType([import_prop_types51.default.arrayOf(import_prop_types51.default.string), import_prop_types51.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types51.default.arrayOf(import_prop_types51.default.object),
   ...
   * @default false
   */
  disableVoronoi: import_prop_types51.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types51.default.shape({
    horizontal: import_prop_types51.default.bool,
    vertical: import_prop_types51.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types51.default.shape({
    dataIndex: import_prop_types51.default.number,
    seriesId: import_prop_types51.default.oneOfType([import_prop_types51.default.number, import_prop_types51.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types51.default.oneOfType([import_prop_types51.default.object, import_prop_types51.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types51.default.shape({
   ...
   * @param {ScatterItemIdentifier} scatterItemIdentifier The scatter item identifier.
   */
  onItemClick: import_prop_types51.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types51.default.oneOfType([import_prop_types51.default.object, import_prop_types51.default.string]),
  /**
   * The series to display in the scatter chart.
   * An array of [[ScatterSeriesType]] objects.
   */
  series: import_prop_types51.default.arrayOf(import_prop_types51.default.object).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default { trigger: 'item' }
   */
  tooltip: import_prop_types51.default.shape({
    axisContent: import_prop_types51.default.elementType,
    classes: import_prop_types51.default.object,
    itemContent: import_prop_types51.default.elementType,
    slotProps: import_prop_types51.default.object,
    slots: import_prop_types51.default.object,
    trigger: import_prop_types51.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types51.default.oneOfType([import_prop_types51.default.object, import_prop_types51.default.string]),
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types51.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types51.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types51.default.arrayOf(import_prop_types51.default.shape({
    classes: import_prop_types51.default.object,
    colorMap: import_prop_types51.default.oneOfType([import_prop_types51.default.shape({
      colors: import_prop_types51.default.arrayOf(import_prop_types51.default.string).isRequired,
      type: import_prop_types51.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types51.default.string,
      values: import_prop_types51.default.arrayOf(import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number, import_prop_types51.default.string]).isRequired)
    }), import_prop_types51.default.shape({
      color: import_prop_types51.default.oneOfType([import_prop_types51.default.arrayOf(import_prop_types51.default.string.isRequired), import_prop_types51.default.func]).isRequired,
      max: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
      min: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
      type: import_prop_types51.default.oneOf(["continuous"]).isRequired
    }), import_prop_types51.default.shape({
      colors: import_prop_types51.default.arrayOf(import_prop_types51.default.string).isRequired,
      thresholds: import_prop_types51.default.arrayOf(import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]).isRequired).isRequired,
      type: import_prop_types51.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types51.default.array,
    dataKey: import_prop_types51.default.string,
    disableLine: import_prop_types51.default.bool,
    disableTicks: import_prop_types51.default.bool,
    fill: import_prop_types51.default.string,
    hideTooltip: import_prop_types51.default.bool,
    ...
    labelFontSize: import_prop_types51.default.number,
    labelStyle: import_prop_types51.default.object,
    max: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
    min: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
    position: import_prop_types51.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types51.default.bool,
    scaleType: import_prop_types51.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types51.default.object,
    slots: import_prop_types51.default.object,
    stroke: import_prop_types51.default.string,
    tickFontSize: import_prop_types51.default.number,
    tickInterval: import_prop_types51.default.oneOfType([import_prop_types51.default.oneOf(["auto"]), import_prop_types51.default.array, import_prop_types51.default.func]),
    tickLabelInterval: import_prop_types51.default.oneOfType([import_prop_types51.default.oneOf(["auto"]), import_prop_types51.default.func]),
    tickLabelPlacement: import_prop_types51.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types51.default.object,
    tickMaxStep: import_prop_types51.default.number,
    tickMinStep: import_prop_types51.default.number,
    tickNumber: import_prop_types51.default.number,
    tickPlacement: import_prop_types51.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types51.default.number,
    valueFormatter: import_prop_types51.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types51.default.arrayOf(import_prop_types51.default.shape({
    classes: import_prop_types51.default.object,
    colorMap: import_prop_types51.default.oneOfType([import_prop_types51.default.shape({
      colors: import_prop_types51.default.arrayOf(import_prop_types51.default.string).isRequired,
      type: import_prop_types51.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
    min: import_prop_types51.default.oneOfType([import_prop_types51.default.instanceOf(Date), import_prop_types51.default.number]),
    position: import_prop_types51.default.oneOf(["left", "right"]),
    reverse: import_prop_types51.default.bool,
    scaleType: import_prop_types51.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types51.default.object,
    slots: import_prop_types51.default.object,
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types51.default.arrayOf(import_prop_types51.default.shape({
    colorMap: import_prop_types51.default.oneOfType([import_prop_types51.default.shape({
      colors: import_prop_types51.default.arrayOf(import_prop_types51.default.string).isRequired,
      type: import_prop_types51.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types51.default.string,
...
var _excluded47 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React100.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime71.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    }), plotType === "line" && (0, import_jsx_runtime71.jsxs)(React100.Fragment, {
    ...
    }), (0, import_jsx_runtime71.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime71.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types52.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types52.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types52.default.arrayOf(import_prop_types52.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types52.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types52.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types52.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types52.default.shape({
    classes: import_prop_types52.default.object,
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types52.default.shape({
    classes: import_prop_types52.default.object,
    colorMap: import_prop_types52.default.oneOfType([import_prop_types52.default.shape({
      colors: import_prop_types52.default.arrayOf(import_prop_types52.default.string).isRequired,
      type: import_prop_types52.default.oneOf(["ordinal"]).isRequired,
...
var GaugeContext = React101.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React101.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime73 = __toESM(require_jsx_runtime());
var _excluded48 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React102.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const svgRef = React102.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime73.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime73.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      children: (0, import_jsx_runtime73.jsx)(GaugeProvider, {
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime73.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types53.default.oneOfType([import_prop_types53.default.number, import_prop_types53.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types53.default.oneOfType([import_prop_types53.default.number, import_prop_types53.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types53.default.oneOfType([import_prop_types53.default.number, import_prop_types53.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types53.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types53.default.oneOfType([import_prop_types53.default.number, import_prop_types53.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   * @default object Depends on the charts type.
   */
  margin: import_prop_types53.default.shape({
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types53.default.oneOfType([import_prop_types53.default.number, import_prop_types53.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types53.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types53.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types53.default.number,
  viewBox: import_prop_types53.default.shape({
    height: import_prop_types53.default.number,
    width: import_prop_types53.default.number,
    x: import_prop_types53.default.number,
    y: import_prop_types53.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime74.jsx)(StyledPath, _extends({
...
var _excluded49 = ["text", "className"];
...
true ? GaugeValueText.propTypes = {
   ...
   * Height of a text line (in `em`).
   */
  lineHeight: import_prop_types54.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types54.default.bool,
  ownerState: import_prop_types54.default.any,
  /**
   * Style applied to text elements.
   */
...
var _excluded50 = ["text", "children", "classes", "className"];
...
var Gauge = React106.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  desc: import_prop_types55.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types55.default.bool,
  /**
   * The end angle (deg).
   * @default 360
   */
  endAngle: import_prop_types55.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types55.default.number,
  /**
   * The radius between circle center and the beginning of the arc.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the maximal radius that fit into the drawing area.
   * @default '80%'
   */
  innerRadius: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   * @default object Depends on the charts type.
   */
  margin: import_prop_types55.default.shape({
    bottom: import_prop_types55.default.number,
    left: import_prop_types55.default.number,
    right: import_prop_types55.default.number,
    top: import_prop_types55.default.number
  }),
  /**
   * The radius between circle center and the end of the arc.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types55.default.number,
  ...
  text: import_prop_types55.default.oneOfType([import_prop_types55.default.func, import_prop_types55.default.string]),
   ...
   * @default 100
   */
  valueMax: import_prop_types55.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types55.default.number,
  viewBox: import_prop_types55.default.shape({
    height: import_prop_types55.default.number,
    width: import_prop_types55.default.number,
    x: import_prop_types55.default.number,
    y: import_prop_types55.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
