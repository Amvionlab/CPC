...
import {
  ...
  useYScale,
  useZColorScale
} from "./chunk-LQCSAYIV.js";
import "./chunk-XRBWQJJH.js";
import "./chunk-S67K75GH.js";
import "./chunk-H3APZWDU.js";
import "./chunk-I2JQ2LQ7.js";
import "./chunk-LWABFYW2.js";
import {
  useTheme
} from "./chunk-YKLMJL35.js";
import "./chunk-CZ4OSWRB.js";
import "./chunk-2CGVJHQ3.js";
>>>>>>> 27abfad18f81b4b3ce9e4f512b8d553fb44f2872
import "./chunk-2UH2JP76.js";
import "./chunk-7ISBXW3Y.js";
import "./chunk-D7ZASVPN.js";
import {
  arc_default
} from "./chunk-7NNHX3HH.js";
import "./chunk-XNBLTNAJ.js";
import "./chunk-MHZWSL4K.js";
import {
...
=======
  useForkRef
} from "./chunk-D7MJDRAW.js";
import "./chunk-TKGRRW76.js";
import {
  styled_default
} from "./chunk-5CM2ZLAH.js";
>>>>>>> 27abfad18f81b4b3ce9e4f512b8d553fb44f2872
import {
  composeClasses,
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types3.default.shape({
    fade: import_prop_types3.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types3.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types3.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React6.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime6.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime6.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types5.default.string,
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime8.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime8.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
  ...
  data: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    ...
    label: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.string]),
  ...
  return (0, import_jsx_runtime9.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime9.jsx)("g", {
        ...
        children: (0, import_jsx_runtime9.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime9.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime9.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React11.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime10.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime10.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime10.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation
    }), (0, import_jsx_runtime10.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime10.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime10.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  const cleanData = React12.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime11.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime11.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types9.default.func,
  markerSize: import_prop_types9.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  xScale: import_prop_types9.default.func.isRequired,
  yScale: import_prop_types9.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(React13.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime12.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color,
        colorGetter,
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded6 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React14.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime13.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime13.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime13.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime13.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime13.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime13.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime13.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime13.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime13.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime13.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime13.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types11.default.bool,
  /**
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types11.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types11.default.number,
...
var _excluded7 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React15.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime14.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    }), plotType === "line" && (0, import_jsx_runtime14.jsxs)(React15.Fragment, {
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types12.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types12.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types12.default.arrayOf(import_prop_types12.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types12.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types12.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types12.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types12.default.shape({
    classes: import_prop_types12.default.object,
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types12.default.shape({
    classes: import_prop_types12.default.object,
    colorMap: import_prop_types12.default.oneOfType([import_prop_types12.default.shape({
      colors: import_prop_types12.default.arrayOf(import_prop_types12.default.string).isRequired,
      type: import_prop_types12.default.oneOf(["ordinal"]).isRequired,
...
var GaugeContext = React16.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React16.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime16 = __toESM(require_jsx_runtime());
var _excluded8 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React17.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  return (0, import_jsx_runtime16.jsx)(ResizableContainer, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime16.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime16.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime16.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types13.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types13.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types13.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types13.default.number,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime19.jsx)("g", {
    className,
    children: (0, import_jsx_runtime19.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
  ...
  text: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.string])
} : void 0;

// node_modules/@mui/x-charts/esm/Gauge/Gauge.js
var import_jsx_runtime20 = __toESM(require_jsx_runtime());
var _excluded10 = ["text", "children", "classes", "className"];
...
var Gauge = React21.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime20.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime20.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime20.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime20.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types15.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  ...
  text: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.string]),
   ...
   * @default 100
   */
  valueMax: import_prop_types15.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types15.default.number,
